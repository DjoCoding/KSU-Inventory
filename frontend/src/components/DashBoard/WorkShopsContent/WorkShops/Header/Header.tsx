    ...
    return(
        <div className="flex justify-center md:justify-between items-center flex-wrap gap-4">
            <h1 className="capitalize font-bold text-5xl text-black/60">workshops</h1>
            {
                user.role === "admin"
                &&
                <button onClick={openForm} className="flex items-center gap-1 bg-primary px-2 py-2 rounded-xl cursor-pointer hover:scale-105 focus:scale-95 duration-100 transition">
